            ...
            switch (elem.type) {
                ...
                case 'Texto':
                    return `<div class="Frame FormItem Texto" ${condicao}>
                        <div class="Titulo Texto">${elem.label}</div>
                         ${comentario}
                        <input type="text" class="inputData Texto" id="${elem.qid}" name="${elem.qid}_${elem.var}" data-var="${elem.qid}_${elem.var}">
                    </div>`;
                case 'MEscolha':
                    return `<div class="Frame FormItem MEscolha" ${condicao}>
                        ...
                        <div class="inputData iMEscolha">
                            ${elem.opcoes.map((opcao, index) => `
                                <input type="checkbox" id="${elem.qid}_${index}" value="${opcao}" name="${elem.var}[]" data-var="${elem.var}">
                ...
                case 'Escolha2':
                    return `<div class="Frame FormItem MEscolha" ${condicao}>
                        ...
                        <div class="inputData iMEscolha">
                            ${elem.opcoes.map((opcao, index) => `
                                <input type="radio" id="${elem.qid}_${index}" name="${elem.qid}_${elem.var}" value="${opcao}" data-var="${elem.var}">
                                <label for="${elem.qid}_${index}">${opcao}</label><br>
                            `).join('')}
                        </div>
                    </div>`;
                case 'Escolha1':
                    return `<div class="Frame FormItem Escolha1" ${condicao}>
                        <div class="Titulo Escolha1">${elem.label}</div>
                         ${comentario}
                        <select class="inputData Escolha1" id="${elem.qid}" name="${elem.qid}_${elem.var}" data-var="${elem.var}">
                ...
                case 'Grade':
                    return `<div class="Frame FormItem Grade" ${condicao}>
                        <div class="Titulo Grade">${elem.label}</div>
                         ${comentario}
                        <table border="" class="inputData iGrade" id="${elem.qid}_${elem.var}" data-var="${elem.var}">
                            <tbody>
                                ...
                                ${elem.questoes.map((questao, indexQ) => `
                                    <tr>
                                        ...
                                        ${elem.opcoes.map((opcao, indexOp) => `
                                            <td>
                                                <input type="radio" id="${elem.qid}_${indexQ}_${indexOp}" name="${elem.qid}_${indexQ}_${elem.var}" value="${opcao}" data-var="${elem.qid}_${elem.var}">
                                            </td>
                                        `).join('')}
                                    </tr>
                                `).join('')}
