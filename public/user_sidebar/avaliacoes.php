...
@media (max-width: 768px) {
    ...
    .content {
        margin-left: 0;
        width: 100%;
        padding-top: 60px; /* Para garantir espaço para a navbar */
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" id="navbar">
        ...
        <div class="content-container">
            <div class="container mt-5">
                ...
                <p style="color: red;">Realizar preferencialmente usando computador.<p/>
                <div class="row">
    ...
    // Se estiver em uma tela menor, faz a sidebar aparecer sobre o conteúdo
